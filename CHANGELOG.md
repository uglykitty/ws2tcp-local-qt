...
- *(network)* Send `User-Agent` on the gateway websocket handshake

## [0.3.2] - 2026-09-17

### 🚀 Features

- *(network)* Identify client in outgoing request headers
...
- *(update)* Download update installer in-app instead of opening browser

## [0.2.0] - 2026-09-16

### 🚀 Features

- *(wsl)* Show popups for WSL menu results and guard against quitting mid-install

## [0.1.23] - 2026-09-16

### 🐛 Bug Fixes

- *(wsl)* Skip elevation when Install WSL finds WSL already ready

## [0.1.22] - 2026-09-16

### 🚀 Features

- *(update)* Add in-app update check and self-hosted release mirror

### 🐛 Bug Fixes

- *(update)* Avoid windows.h max macro clobbering std::max

## [0.1.20] - 2026-09-15

### 🚀 Features

- *(wsl)* Gate WSL actions on a fast readiness check
...
- *(installer)* Quit the running instance before uninstall or upgrade
